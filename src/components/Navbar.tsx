...
const NavContainer = tw.nav`w-full  bg-green-700 text-white  flex justify-center items-center `;
const Nav = tw.div`w-full max-w-screen-xl  flex justify-between items-center px-4  py-2 md:px-12`;
